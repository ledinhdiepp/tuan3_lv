...
class AccountList extends Component {
    ...
    render(){
        ...
        const clickUpdate = (id) =>{
            this.props.history.push('/admin/account/'+id+'/update')
        }
        ...
        return(
            <div className="DataList">
                ...
                <Link to='/admin/account/create'><button className="btn btn-primary"> Create A New Account</button></Link>
                <div className="DataList-container">
                    
                    <div className="DataList-filter" onSubmit={this.filterSubmmitHandle}>
                    <form className="form-inline w-100">
                        <input className="form-control" name="username_filter" type="text"
